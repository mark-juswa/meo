          ...
          <div className="w-full max-w-md rounded-2xl bg-gray-50 p-8 shadow-xl md:p-10 border border-gray-100 mt-4 md:mt-0">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6">
              ...
              <div className="text-right">
                <a href="#" className="text-sm font-medium text-blue-400 hover:text-blue-600">Forgot password?</a>
              </div>

              <button type="submit" id="login-button" className="w-full rounded-3xl bg-blue-500 py-3.5 font-semibold text-white shadow-sm transition-colors hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Log in
              </button>
            </form>
